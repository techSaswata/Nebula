    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="mt-16 text-center">
                  ...
                  <div className="space-y-2 text-left mb-6">
                    ...
                    <ul className="text-sm space-y-1">
                      <li>• AIR 4039 in JEE Advanced 2024</li>
                      <li>• 1k+ followers on LinkedIn</li>
                      <li>• Member of Innovation Lab</li>
                    </ul>
                  </div>
                  <Link href="" className="w-full">
                    <Button variant="outline" className="w-full border-[#000000] text-[#000000] hover:bg-[#000000]/10">
                      Connect on LinkedIn
                    </Button>
                  </Link>
                </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
              <div className="h-40 bg-[#4361EE]"></div>
              <div className="p-6 relative">
                <div className="absolute -top-16 left-1/2 -translate-x-1/2">
                  <img
      ...
      <footer className="py-12 px-4">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Vector</h3>
